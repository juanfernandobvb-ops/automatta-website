      ...
      <div class="about-grid">
        <div class="about-content">
          <div class="manifesto-text">
            <p>AUTOMATTA transcends conventional musical boundaries, forging a new path through experimental soundscapes and electronic innovation.</p>
            <p>Our sound is the collision between organic and synthetic, where human emotion meets digital precision.</p>
              ...
              <div class="member-card-large">
                ...
                <div class="member-info-large">
                  ...
                  <div class="member-description-large">
                    Breve comentário sobre o membro, sua experiência musical e contribuição para o som da AUTOMATTA. Adicione aqui o que quiser sobre cada integrante da banda.
                  </div>
...
.hero-left {
  ...
  justify-content: center;
  background: linear-gradient(45deg, #0E0E0F, #1C1E22);
}
